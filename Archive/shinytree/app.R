...
# Dependencies: shiny, shinydashboard, shinycssloaders, shinydashboardPlus, shinytree_helper.R
...
server <- function(input, output, session) {
    ...
    output$save <- downloadHandler(
      filename = function() {
        paste(input$model, "_", input$bootstraps, "bootstraps_", input$style, "_", Sys.Date(), ".png", sep = "")
      },
