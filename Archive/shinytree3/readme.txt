...
shinydashboardPlus 0.7.5<br>

## Use:
To install, extract the zip file in your working directory and ensure all dependencies are installled.  The app can then be called by  executing runApp("shinytree") in R.
...
A tree can be saved as a .png image by using the "save" button on the tree tab.  
